...
public class CategoryCreateRequest extends BaseDTO {
    ...
    @NotNull(message = "Parent ID cannot be null", groups = ValidationGroups.Create.class)
    @Schema(description = "Parent category ID, 0 for root", example = "0")
    private Long parentId;
    
    @NotBlank(message = "Category name cannot be empty", groups = ValidationGroups.Create.class)
    @Schema(description = "Category name", example = "Electronics")
    private String categoryName;
    
    @NotBlank(message = "Category code cannot be empty", groups = ValidationGroups.Create.class)
    @Schema(description = "Category code", example = "ELEC")
    private String categoryCode;
    
    @NotNull(message = "Level cannot be null", groups = ValidationGroups.Create.class)
